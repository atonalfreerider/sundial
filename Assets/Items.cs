...
public static class Items {
    ...
    public static Material mainFontMatO;
    ...
    public static void AddCanvas2(GameObject passGO) {
    ...
    public static Text NewText2(string passText, Color color1, int fontSize, TextAnchor align, bool outline) {
        GameObject textBox = new GameObject();
    ...
    public static GameObject YearLine(string year, float earthLineL) {
        GameObject yearLine = new GameObject();
        yearLine.name = "yearLine";
        AddCanvas2(yearLine);
