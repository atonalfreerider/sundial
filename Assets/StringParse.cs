...
public static class StringParse {
    ...
    public static string FirstLine(string passS) {
    ...
    public static string ChopLine(string passS) {
        ...
        return passS.Substring(passS.IndexOf(";") + 3); // skip over ; and \r\n;
    }
    ...
    public static string Block(string passS, string start, string upTo) {
        if (passS.IndexOf(start) < 0)
            return "";

        return passS.Substring(passS.IndexOf(start), passS.IndexOf(upTo) - passS.IndexOf(start));
    }
